...
public class Settings {
	 ...
	 * for providing default values. The search order for settings is as follows:
	 * <ol>
	 ...
	 * <li>the value returned by this method, which is <code>null</code>
	 *     in this base class
	 * </ol>
	 * 
	 ...
	 * @param value the object whose string representation will become the the value of <code>key</code>
	 */
	 ...
	 * by converting the string value of the key using <code>parser</code>.
	 * This method returns <code>defaultValue</code> if the conversion fails
	 * or if <code>key</code> is not defined.
	 * 
	 * @param key
	 * @param parser
	 */
	...
	/**
	 * Remove a setting from this container, returning the value to
	 * its default.
	...
	/**
	 * Parse a <code>Color</code> in hexadecimal RRGGBB format from key.
	 * The value may be prefixed with a '#'character (which follows the syntax
	 * of colours in HTML). The value may optionally include a leading
	 * alpha component (AARRGGBB) to specify a translucent colour.
	 * If the value is not defined or cannot be parsed, the default
	 * value is returned.
	 */
	 ...
	 * <code>key</code>. This is similar to calling <code>clazz.getResource</code>
	 * using the setting value for <code>key</code> as the resource name.
	 * The value of <code>clazz</code> may be <code>null</code>, in which case
	 * the resource will be fetched using <code>ClassLoader.getSystemResource</code>.
	 * <p>
	 ...
	 * @param clazz a class to use as the base for a relative URL (may be <code>null</code>)
	 * @param key the settings key which holds the resource name
	 * @param defaultValue the default resource name to use if none is defined in the settings (may be <code>null</code>)
	 * @return the resource URL, or <code>null</code> if the resource or resource name does not exist
	 */
	 ...
	 * @param key the settings key which holds the resource name
	 * @return the resource URL, or <code>null</code> if the resource or resource name does not exist
	 * @see {@link #getResource(java.lang.Class, java.lang.String, java.lang.String)}
	 */
	...
	/**
	 * Return the requested resource as a stream, or return <code>null</code>
	 * if the resource does not exist, if <code>key</code> is not defined and
	 ...
	 * @param key the settings key which holds the resource name
	 * @param defaultValue the default resource name to use if none is defined in the settings (may be <code>null</code>)
	 * @return a stream for the resource, or <code>null</code> if the resource or resource name does not exist
	 */
	...
	/**
	 * A convenience method for <code>getResourceAsStream( null, key, null )</code>.
	 *
	 * @param key the settings key which holds the resource name
	 * @return a stream for the resource, or <code>null</code> if the resource or resource name does not exist
	 * @see {@link #getResourceAsStream(java.lang.Class, java.lang.String, java.lang.String)}
	 */
	 ...
	 * @param key the settings key which holds the resource name
	 * @param defaultValue the default resource name to use if none is defined in the settings (may be <code>null</code>)
	 * @return the image pointed to by the value of the setting, or <code>null</code>
	 */
	 ...
	 * @param key the settings key which holds the resource name
	 * @return the image pointed to by the value of the setting, or <code>null</code>
	 * @see {@link #getImage(java.lang.Class, java.lang.String, java.lang.String)}
	 */
	 ...
	 * @return a <code>boolean</code> value derived from the value of <tt>key</tt>
	 */
	...
	/**
	 * Parse an integer from the value of <code>key</code>. If the
	 * setting is undefined, <code>defaultValue</code> is returned.
	 * If the value of the key is prefixed by any of <tt>#</tt>, character,
	 ...
	 * @return an integer derived from the value of <code>key</code>, or <code>defaultValue</code>
	 */
	...
	/**
	 * Parse a float from the value of <code>key</code>. If the
	 * setting is undefined, <code>defaultValue</code> is returned.
	 * @param key the settings key with the desired value
	 * @param defaultValue the default to use if <code>key</code> is undefined
	 * @return a float derived from the value of <code>key</code>, or <code>defaultValue</code>
	 */
	...
	/**
	 * Parse a double from the value of <code>key</code>. If the
	 * setting is undefined, <code>defaultValue</code> is returned.
	 * @param key the settings key with the desired value
	 * @param defaultValue the default to use if <code>key</code> is undefined
	 * @return a double derived from the value of <code>key</code>, or <code>defaultValue</code>
	 */
	...
	/**
	 * Return a rectangle by parsing a comma-separated list of integers
	 ...
	 * @return a rectangle with coordinates taken from <code>key</code>, or <code>defaultValue</code>
	 */
	...
	/**
	 * Return a rectangle by parsing a comma-separated list of numbers
	 * in x, y, width, height order.
	 * @param key the key of the setting to parse
	 * @param defaultValue the default to use if the key is missing
	 * @return a rectangle with coordinates taken from <code>key</code>, or <code>defaultValue</code>
	 ...
	 * @param key the key of the setting to parse
	 * @param defaultValue the default to use if the key is missing
	 * @return a <code>Point</code> with coordinates taken from <code>key</code>, or <code>defaultValue</code>
	 */
	...
	/**
	 * Return a <code>Point2D</code> by parsing a comma-separated list of numbers
	 * in x, y order.
	 * @param key the key of the setting to parse
	 * @param defaultValue the default to use if the key is missing
	 * @return a <code>Point</code> with coordinates taken from <code>key</code>, or <code>defaultValue</code>
	...
	/**
	 * This is a utility method that attempts to locate a <code>Locale</code>-specific
	 * version of any resource. It returns a result similar to calling
	 * <pre>
	 * thisClass.getResource( namePrefix + nameSuffix )
	 * </pre>
	 * except that it will search for locale-specific versions of the resource
	 * using a similar naming convention as that used for <code>ResourceBundle</code>s.
	 * That is, names will be generated by inserting a string between
	 * <code>namePrefix</code> and <code>nameSuffix</code> that consists of
	 * an underscore and one or more underscore-separated components of the locale
	 * name in language, country, variant order.
	 * <p>
	 * Localized versions of the resource are searched for using
	 * <code>thisClass.getResource</code> starting with the most specific
	 * locale available (language, country, and variant) and working backwards.
	 * <p>
	 * For example, calling 
	 * <pre>
	 * findResourceForLocale( thisClass, Locale.CANADA_FRENCH, "image", ".png" )
	 * </pre>
	 * would search first for a resource with the name <code>image_fr_CA.png</code>,
	 * then <code>image_fr.png</code>, and finally <code>image.png</code>. As
	 * soon as <code>getResource</code> returned a non-<code>null</code> value
	 * for one of these resources, that URL would be returned. If <code>null</code>
	 * was returned for all of these calls, then <code>null</code> is returned.
	 * 
	 ...
	 * @return the URL of the best available version of the resource, or <code>null</code>
	...
	/**
	 * This is a convenience for {@link #findResourceForLocale(java.lang.Class, java.util.Locale, java.lang.String, java.lang.String)}
	 ...
	 * If a '.' does not appear in the last path segment of the resource name,
	 * then the suffix is empty.
	 * In other words, given the name of the default version of a resource that
	 * uses the standard <code>file.extension</code> convention for file names, this
	 * method finds the best available localized version.
	 * 
	 * @param thisClass the class to use as a base for the search
	 * @param locale the locale to find the best-matching localized version for
	...
	/**
	 * Parse a list of int values. If any number can't be parsed or
	 * the actual list has fewer than <code>minimumLength</code> entries,
	 * or more than <code>maximumLength</code> entries, this method returns
	 * <code>null</code>.
	...
	/**
	 * Parse a list of double values. If any number can't be parsed or
	 * the actual list has fewer than <code>minimumLength</code> entries,
	 * or more than <code>maximumLength</code> entries, this method returns
	 * <code>null</code>.
	 * @param s the string to parse
