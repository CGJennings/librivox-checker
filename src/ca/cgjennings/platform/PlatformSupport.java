...
public class PlatformSupport {
    ...
    /**
     * A variant look and feel for OS X that is popular with developers. It
     * needs to be handled differently from Apple's Aqua L&F in some cases.
     *
     ...
     * Windows and X order, where Cancel comes last and OK comes just to its
     * left. What is swapped: default button status, text, enabled state, and
     * action listeners. (It does not currently swap icons because no Checker
     * dialogs use icons on their OK or Cancel buttons.)
     *
    ...
    /**
     * Given the OK and Cancel buttons for a dialog, this will return whichever
     * button represents OK after calling {@link #correctOKCancelOrder}. This is
     * useful if you want to, for example, disable the OK button in response to
     * user input.
     *
     * @param ok the button that was designed to represent OK
     * @param cancel the button that was designed to represent Cancel
    ...
    /**
     * Given the OK and Cancel buttons for a dialog, this will return whichever
     * button represents Cancel after calling {@link #correctOKCancelOrder}.
     *
     * @param ok the button that was designed to represent OK
     * @param cancel the button that was designed to represent Cancel
