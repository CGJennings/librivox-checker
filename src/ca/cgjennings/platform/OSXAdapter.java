...
public class OSXAdapter implements InvocationHandler {
     ...
     */
    public static boolean setQuitHandler(Object target, Method quitHandler) {
        return setHandler(new OSXAdapter("handleQuit", target, quitHandler));
    }
    ...
    public static boolean setHandler(OSXAdapter adapter) {
