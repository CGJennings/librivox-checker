...
public class FileDrop {
	...
	/** The component to apply a border to. */
	private Component borderComponent;
	private transient javax.swing.border.Border normalBorder;
	private transient java.awt.dnd.DropTargetListener dropListener;
	/** Discover if the running JVM is modern enough to have drag and drop. */
	private static Boolean supportsDnD;	// Default border color
	private static java.awt.Color defaultBorderColor = new java.awt.Color(0, 0, 255, 200 );
			...
			dropListener = new java.awt.dnd.DropTargetListener() {
				...
				public void dragEnter( java.awt.dnd.DropTargetDragEvent evt ) {
					...
					if( isDragOk( out, evt ) ) {
						...
						if( dragBorder != null && FileDrop.this.borderComponent instanceof javax.swing.JComponent ) {
							javax.swing.JComponent jc = (javax.swing.JComponent) FileDrop.this.borderComponent;
				...
				public void drop( java.awt.dnd.DropTargetDropEvent evt ) {
					...
					try {   // Get whatever was dropped
						...
						if( tr.isDataFlavorSupported( java.awt.datatransfer.DataFlavor.javaFileListFlavor ) ) {
							...
							if( listener != null ) {
								listener.filesDropped( files );							// Mark that drop is completed.
							}
						...
						else // this section will check for a reader flavor.
						{
							...
							for( int zz = 0; zz < flavors.length; zz++ ) {
								if( flavors[zz].isRepresentationClassReader() ) {
									...
									if( listener != null ) {
										listener.filesDropped( createFileArray( br, out ) );									// Mark that drop is completed.
									}
									evt.getDropTargetContext().dropComplete( true );
									log( out, "FileDrop: drop complete." );
									handled = true;
	...
	public void setLoggingStream( PrintStream log ) {
		out = log;
	}
