...
private void strictItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_strictItemActionPerformed
	 ...
	 * <code>setWaitCursor( false )</code> statement in a
	...
	private static void initLookAndFeel() {
		...
		boolean installSystemLaF = true;
		try {
			LookAndFeelInfo[] lafs = UIManager.getInstalledLookAndFeels();
			for( int i = 0; i < lafs.length; ++i ) {
				if( lafs[i].getName().equals( "Nimbus" ) ) {
					UIManager.setLookAndFeel( lafs[i].getClassName() );
					installSystemLaF = false;
					break;
				}
			}
		} catch( Exception e ) {
	 ...
	 * language on the platform. If the optional
	 * <code>arguments</code> are provided, they will be used to format the
	 * fetched string as if by<br>
	 * <code>
	 * String.format( Locale.getDefault(), text, arguments )
	 * </code>
	 *
	 * <p>If the requested key is not defined, the returned string take the form
	...
	/**
	 * Return a localized text string. The value of
	 * <code>key</code> will be fetched from the
	 * <tt>text_<i>XX</i>.properties</text> file appropriate for the default
	...
	/**
	 * Returns
	 * <code>true</code> if a string is defined in the string resource table.
	 *
	...
	/**
	 * Returns the
	 * <code>Logger</code> used for logging errors and other messages from the
	 * application.
	 *
