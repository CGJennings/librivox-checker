...
public class LibriVoxAudioFile {
    ...
    public enum Status {
        /**
         * State indicating that the file is queued and will be analyzed when a
         * free worker thread is available.
         */
        QUEUED(true),
        /**
         * State indicating that the audio data is being downloaded from a
         * server.
         */
        DOWNLOADING(true),
        /**
        ...
        FAILED(false),
        /**
         * State indicating that analysis could not be completed due to an
         * error.
         */
        ERROR(false),
        /**
         * Status indicating that this object has been disposed to free
         * underlying resources. Methods such as {@link #getInformationReport}
        ...
        /**
         * Returns true if this status is a stage in the validation, that is, if
         * the file's status will change over time. When the current status of a
         * file has this property, the file is still being processed.
         *
    ...
    /**
     * When a file is not thought to be an MP3 file, this method is called to
     * try to guess the file type and create an appropriate message.
     */
    ...
    /**
     * Returns <code>true</code> if this <code>LibriVoxAudioFile</code> is
     * currently busy being downloaded or analyzed.
     *
     ...
     * similar to <code>!isBusy()</code>, but it also returns <code>false</code>
     * if the file is still in the queue and hasn't started analysis yet.
     *
     * @return
     */
    ...
    /**
     * Return <code>true</code> if this <code>LibriVoxAudioFile</code> is a
     * local file (rather than one obtained over the network a via a URL).
     *
     ...
     * by this <code>LibriVoxAudioFile</code>. This is the intended name for the
     * file as it might appear in a catalog. This might not be the same as
     * <code>getLocalFile().getName()</code>, because files that are obtained
     * from URL sources will return a randomly-named temporary file.
     *
     ...
     * or analyzed, this process will be interrupted. If
     * <code>waitForJobToCancel</code> is <code>true</code>, then this method
     * will not return until the thread performing the analysis stops. (If in
     * doubt, set this to <code>true</code>.)
     *
     * @param waitForJobToCancel if <code>true</code>, wait for the worker
     * thread to stop before returning
     */
    ...
    /**
     * <b>Important:</b> assumes that setCurrentProgress() will be called
     * shortly; the call to setCurrentProgress will fire the progress update---
     * both this and setCurrentProgress should be called from within a
     * synchronized block (synching on this file).
     *
     * @param max
     */
    ...
    /**
     * Returns the current progress value as a floating point value between 0
     * and 1, or -1 if the notion of "progress" does not currently apply.
     *
