...
/**
 * A filter that can be used to exclude all but MP3 files, ZIP files, and directories.
 * It can be used as either a <code>javax.swing.filechooser.JFileChooser</code> filter,
 * or a <code>java.io.FileFilter</code>.
