...
/**
 * Performs ReplayGain loudness analysis on audio data.
 * To use this to analyze a series of MP3 frames, create an instance
 * of <code>ReplayGainAnalyzer</code> and submit each frame in turn
 * by calling {@link #processFrame}. Once all frames are processed,
 * call {@link #done} to obtain an {@link Analysis} instance. This
 * provides the methods needed to determine loudness and compute gain
 * adjustments.
 */
/*
...
final class ReplayGainAnalyzer {
	...
	/**
	 * The results of a ReplayGain analysis. This can be used to determine
	 * the data's standard volume and compute gain adjustments.
	 */
	public static final class Analysis {
		...
		/**
		 * Get the dB adjustment required to set the track to the
		 * specified standard volume.
		 */
