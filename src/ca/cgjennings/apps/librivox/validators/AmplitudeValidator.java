...
/**
 * A validator for the audio data: volume, sample rate, channel format,
 * and so on.
 *
...
public class AmplitudeValidator extends AbstractValidator {
	...
	/**
	 * If the number of channels is one, return <code>channel1</code>.
	 * Otherwise return a string that formats both <code>channel1</code>
	 * and <code>channel2</code> as a two channel data value.
	 *
	 * @param channel1 a string representing channel 1's data value
	 * @param channel2 a string representing channel 2's data value
	 * @return a string representing one or both data values depending on
