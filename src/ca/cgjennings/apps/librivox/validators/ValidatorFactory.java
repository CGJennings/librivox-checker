...
/**
 * Manages the instantiation of {@link Validator} instances used to
 * validate a {@link LibriVoxAudioFile}. The validators to be used
 * are determined by parsing the <tt>resources/validator_classes</tt> file.
 *
...
public class ValidatorFactory {
	private ValidatorFactory() {
		...
		try {
			...
			if( in == null ) throw new AssertionError( "missing validator class list" );
	...
	public static void setClassEnabled( Class<? extends Validator> c, boolean enable ) {
		if( c == null ) throw new NullPointerException( "class" );
