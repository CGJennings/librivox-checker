...
/**
 * A file processor performs a task on a series of audio files, and presents
 * a dialog showing the progress as it goes. Any errors that occur during
...
public class FileProcessor extends javax.swing.JDialog {
	...
	public void setCancelEnabled( boolean enable ) {
		if( isVisible() ) throw new IllegalStateException("call before starting");
	...
	public void addTask( Task t ) {
		...
		if( t == null ) throw new NullPointerException( "task" );
		tasks.add(t);
	}
	...
	public static abstract class Task {
		...
		/**
		 * This can be called after you complete a task if the file
		 * should be re-checked as a result of the processing.
		 */
