...
class UpgradeMetadataConfigurationDialog extends javax.swing.JDialog {
    ...
    /**
     * Displays the dialog and returns <code>true</code> if the user chooses the
     * OK option.
     *
    ...
    /**
     * Returns <code>true</code> if the tags should be converted to the latest
     * version instead of v23.
     *
     * @return <code>true</code> if tags should be upgraded to the newest
     * version
     */
    ...
    /**
     * Returns <code>true</code> if obsolete tags should be deleted from the
     * file.
     *
