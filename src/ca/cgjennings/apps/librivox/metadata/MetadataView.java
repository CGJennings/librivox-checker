...
public interface MetadataView {
	...
	/**
	 * Returns the first (and typically only) embedded image, or <code>null</code>
	 * if no image is embedded.
	 *
	...
	/**
	 * Returns the full size version of the embedded image, or <code>null</code>.
