...
public class ImageUtils {
    ...
    /**
     * Resizes an image to fit a maximum dimension. If either the width or
     * height of the image is greater than <code>maxDimen</code>, the image will
     * be scaled down so that its largest dimension is <code>maxDimen</code>
     * pixels.
     *
    ...
    /**
     * Creates a temporary file that will last until the end of the session and
     * which contains the image data in PNG format and returns a URL for that
     * file.
     *
