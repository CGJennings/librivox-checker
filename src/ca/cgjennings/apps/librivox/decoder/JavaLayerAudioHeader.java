...
/**
 * An implementation of {@link AudioHeader} for the JavaLayer
 * library.
 *
...
final class JavaLayerAudioHeader implements AudioHeader {
	/**
	 * Creates an {@link AudioHeader} instance from the header of a
	 * JavaLayer stream.
	...
	JavaLayerAudioHeader( Header h ) {
		...
		switch( h.layer() ) {
			case 1: layerType = LayerType.LAYERI; break;
			case 2: layerType = LayerType.LAYERII; break;
			case 3: layerType = LayerType.LAYERIII; break;
			default:
				throw new AssertionError();
		}
