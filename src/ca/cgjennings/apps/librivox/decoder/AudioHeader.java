...
public interface AudioHeader {
	...
	/**
	 * Returns the channel format for the audio, such as <code>MONO</code>
	 * or <code>STEREO</code>.
	...
	/**
	 * Returns the bit rate in kb/s. For variable bit rate
	 * files, this will be an average.
	 * @return the (mean) bit rate, in kb/s
	 */
	int getBitRate();

	/**
	 * Returns <code>true</code> if the header indicates that the stream
	 * uses variable bit rate encoding.
	 * @return <code>true</code> if the stream is VBR
	 */
	boolean isVariableBitRate();

	/**
	 * Returns <code>true</code> if the copyright flag is set, which indicates the file
	...
	/**
	 * Returns <code>true</code> if the original flag is set, which indicates that
	 * the frame is located on its "original media" rather than being a copy.
